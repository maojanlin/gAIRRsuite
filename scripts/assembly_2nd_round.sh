...
python3 parse_contig_realign.py -fs $outer_dir"asm_back_align/TCRV_realign_"$cluster_id".sam" -fo $outer_dir"asm_back_align/TCRV_remain_"$cluster_id".fasta" > $outer_dir"asm_back_align/TCRV_realign_"$cluster_id".rpt" -it_region $interested_region
