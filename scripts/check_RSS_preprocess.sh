...
for allele in ${list_allele}; do
    ...
    python3 check_RSS_preprocess.py -fs   ${outer_dir}${first_dir}/bwa_${person_name}_${allele}_RSS_first_scan.sam \
                                    -ff   ${flanking_file} \
                                    ...
                                    #-fonc ${outer_dir}${first_dir}novel_RSS_${person_name}_${allele}_first_scan.csv \
                                    #-fooc ${outer_dir}${first_dir}original_RSS_${person_name}_${allele}_first_scan.csv \
    ...
    python3 check_RSS.py -fs    ${outer_dir}${second_dir}/bwa_${person_name}_${allele}_RSS_to_missing.sam \
