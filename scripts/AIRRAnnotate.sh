...
allele_dir="../plot_tree/"
allele_suffix="_alleles.fasta"
person_name="NA12878"
...
for allele_name in ${list_allele_name}; do
    ...
    python3 annotation_with_asm.py -foa ${outer_dir}annotation_${person_name}_${allele_name}.txt \
    ...
    echo "[AIRRAnnotate] Fetch flanking sequences from assembly..."
    python3 get_asm_flanking.py -fa ${outer_dir}annotation_imperfect_${person_name}_${allele_name}.txt \
                                -ext 200 \
